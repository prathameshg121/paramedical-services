...
//     setfilterData(healthFacilities);
...
//           if(currUrser.State_Name === state && currUrser.Facility_Type === serv){
//             num++
//             console.log(num + " count " + currUrser.State_Name + " lat " + currUrser.latitude )
//             setavailabilityCount(num/2) ;
//           }
...
//       setfilterData((prevData) => {
//         return prevData.filter((currUrser, index) => {
//           if(currUrser.Facility_Type === serv){
//             num++
//             console.log(num + " count " + currUrser.State_Name + " lat " + currUrser.latitude )
//             setavailabilityCount(num/2) ;
//           }
...
// //   console.log(healthFacilities[0]);
...
<div class="sidebar">
  ...
  <a style={{color:"#3edbf0"}}  onClick={getVacciData}>Vaccin Center</a>

    <a style={{color:"#3edbf0",cursor: "pointer"}} onClick={getBloodData}>Blood Center</a>
    <hr/>
    <a  class="button round blue" onClick={handleNearby}>Find Nearby</a>
    {nearByMe ? (
   ...
   <p style={{color:"#3edbf0"}}>Near by services</p>
    <h6>Enter Radius in Km</h6>
      ...
      <button onClick={getDataUnderRadi} style={{color:"black"}} >Find</button>

    </div>
    ) :("")}

    <a  class="button round blue" style={{width:"50%"}} onClick={handleLatLongDisplay}>Find By LatLong</a>
   {latlongDisplay? (
     <div  class="near-by-container">
